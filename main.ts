...
console.log(` Hina Naseer once said, "Nothing is impossible because IMPOSSIBLE itself is I M POSSIBLE".`);
...
let famous_person:string = "Hina Naseer";
let message:string = `${famous_person} once said, "Nothing is impossible because IMPOSSIBLE itself is I M POSSIBLE"`
console.log(message);
